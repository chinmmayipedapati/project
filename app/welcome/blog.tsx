        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-xl mb-8">
                ...
                <div className="p-6">
                  ...
                  <Link 
                    to="/blog/post-1" 
                    className="inline-block bg-[#00B4D8] text-white px-6 py-2 rounded hover:bg-[#0096B7] transition-colors"
                  >
                    Read More
                  </Link>
                </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-xl">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Plain Text</h3>
                ...
                <Link 
                  to="/blog/plain-text" 
                  className="text-[#00B4D8] hover:text-[#0096B7] transition-colors"
                >
                  Read More
                </Link>
              </div>
            ...
            <div className="space-y-8">
                  ...
                  {[
                    ...
                    <li key={index}>
                      <Link 
                        ...
                        className="text-gray-600 hover:text-[#00B4D8] transition-colors flex items-center"
                      >
              ...
              {/* Recent Post */}
              <div className="bg-white rounded-lg p-6 shadow-xl">
                <h3 className="text-xl font-bold text-gray-800 mb-6">Recent Post</h3>
                <Link 
                  to="/blog/recent-post" 
              ...
              <img 
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-6">Tag Cloud</h3>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <Link
                      ...
                      className="bg-gray-100 text-gray-600 px-3 py-1 rounded hover:bg-[#00B4D8] hover:text-white transition-colors"
                    >
                      {tag}
                    </Link>
                  ))}
